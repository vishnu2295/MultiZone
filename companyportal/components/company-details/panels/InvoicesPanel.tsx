...
const statusStyles: Record<string, string> = {
  Paid: "bg-[#10AD5E1A] text-[#10AD5E]",
  Approved: "bg-[#EFF6FF] text-[#2563EB]",
  Pending: "bg-[#ECB1431A] text-[#ECB143]",
  ...
  return (
    <div className="flex flex-col gap-3">
      {invoices.map((invoice, index) => (
        ...
        >
          <div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-lg bg-[#51B2E01A]">
            <InvoiceIcon className="h-4 w-4 text-[#51B2E0]" />
          </div>
          ...
          <div className="flex flex-1 flex-col gap-1">
            ...
            <p className="text-[11.5px] font-normal leading-[17px] text-[#58585B]">
              Policy Number : {invoice.policyNumber}
            </p>
            <p className="text-[11.5px] font-normal leading-[17px] text-[#58585B]">
