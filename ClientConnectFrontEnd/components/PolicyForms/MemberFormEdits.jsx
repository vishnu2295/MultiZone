...
const MemberFormEdits = ({
  ...
  const filteredBenefits =
    data.PolicyMember.memberTypeId === 4
      ? benefits?.filter(
          (benefit) =>
        ...
        {({ values, dirty, setFieldValue, errors }) => {
          return (
            <Form>
              ...
              {data.PolicyMember.PolicyMemberStatusReason && (
                <Grid sx={{ pt: 2 }} container spacing={2}>
                  <Grid sx={{ pt: 2 }} item xs={6}>
                    <TextfieldWrapper
                      InputProps={{
                      ...
                      name="PolicyMember.PolicyMemberStatusReason"
...
export default MemberFormEdits;
