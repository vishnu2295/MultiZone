...
// import { getCategoryTypes } from "components/Bits/GetCategoryTypes";

const EditPolicy = ({ policyDetails, setPolicyDetails, getRules }) => {
    ...
    <Stack direction="row" spacing={1} sx={{ mb: 2 }}>
      ...
      >
        ...
        <Select
          ...
          value={Number(policyDetails?.selectedCategory)}
