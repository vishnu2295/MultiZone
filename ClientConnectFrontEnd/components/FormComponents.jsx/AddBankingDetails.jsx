...
import SelectBankAccountTypes from "./SelectBankAccountType";
import SelectBankBranch from "./SelectBankBranch";

const BrokerSchemeBankingDetailsModal = ({
  newSchemeId,
  onSuccessfulSubmit,
}) => {
  ...
  const handleAxiosErrors = (error) => {
    ...
    if (error.response) {
      if (
        ...
        errorMessages = error.response.data.message.errmsg;
      } else {
  ...
  const onSubmit = async (values, { resetForm }) => {
    try {
      await addBankingDetails.mutateAsync(values);
      resetForm();
      handleClose();
      onSuccessfulSubmit();
    } catch (error) {
  ...
  return (
    <div>
      ...
      <AlertPopup
        ...
        open={addBankingDetails.isSuccess}
      />
...
export default BrokerSchemeBankingDetailsModal;
