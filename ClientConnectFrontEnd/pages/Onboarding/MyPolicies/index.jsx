...
// TODO: Add a data pagination using  "React-Query"
...
const Policies = ({ loading }) => {
  ...
  let URL = `${nodeSa}/onboarding/policies?createdBy=true&manual=true`;
    ...
    <>
      ...
      >
        ...
        <div>
          ...
          />
          <Chip
            variant={status === "Removed" ? "contained" : "outlined"}
            label="Removed"
            color={status === "Removed" ? "primary" : "default"}
