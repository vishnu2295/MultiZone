...
export const individualNavItems = [
  { label: "Claims", href: "/claimant/claims" },
  // Only shown once the profile response confirms a pensionerDetails record.
  { label: "Pension Ledgers", href: "/claimant/pension-services", requiresPensioner: true },
...
export const homeContent = {
  ...
  organisation: "",
  welcomeMessage:
    "Welcome to your claimant portal, you can manage your insurance, claims, and documents - all in one place.",
  ...
  quickActions: [
    ...
    },
    {
      ...
      href: "/claimant/pension-services",
      highlighted: true,
      // Only shown once the profile response confirms a pensionerDetails record.
    ...
    },
    {
      ...
      href: "/claimant/medical-authorizations",
      highlighted: false,
    },
  ],
};
