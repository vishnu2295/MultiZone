...
import ClaimantBackground from "@/components/common/ClaimantBackground";
    ...
    <ClaimantBackground>
      <div className="relative z-10 mx-auto w-full max-w-[1440px] px-4 py-8 sm:px-6 lg:px-[100px] lg:py-10">
        <Link
          ...
          className="inline-flex items-center gap-2 text-[14px] font-bold text-[#24577A] transition hover:opacity-80"
        >
          <ArrowLeftIcon className="h-4 w-4" aria-hidden />
          {content.backLabel}
        </Link>

        <h1 className="mt-5 text-[20px] font-bold leading-tight text-[#24577A] sm:text-[22px]">
          {content.title}
        </h1>
