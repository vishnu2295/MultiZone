...
interface OnboardingAMLDrawerProps {
  isOpen: boolean;
  onClose: () => void;
  data: any | null;
}

export function OnboardingAMLDrawer({
  isOpen,
  onClose,
  data,
}: OnboardingAMLDrawerProps) {
    ...
    >
      ...
      >
        <Box>
          ...
          <Typography variant="body2" color="text.secondary">
            {data.refId} — Onboarding AML Check
          </Typography>
        </Box>
        <IconButton
          onClick={onClose}
      ...
      >
        <Typography variant="body2" sx={{ color: "text.primary", py: 5 }}>
          ...
          <strong>"{data.refId} — Onboarding AML Check"</strong> request?
        </Typography>
      </Modal>
    </Drawer>
  );
