  ...
  return (
    <div className="flex flex-col gap-4 rounded-xl bg-white px-5 py-5 shadow-[0px_2px_16px_0px_#00000012] sm:flex-row sm:items-center sm:justify-between sm:gap-6 sm:px-6">
      <div className="min-w-0">
        <h2 className="text-[18px] font-bold leading-snug text-[#24577A] sm:text-[16px]">
          {auth.title}
        </h2>

        <div className="mt-2 flex flex-wrap items-center gap-x-2 gap-y-1 text-[12px] text-[#24577A]">
