...
import { AmendmentsAMLDrawer } from "../components/AmendmentsAMLDrawer";
...
export default function AmendmentsAMLTab() {
  ...
  const columns: Column<any>[] = [
    ...
    {
      header: "Risk",
      cell: (row) => <StatusChip status={row.risk} />,
    },
    {
      header: "Broker Name",
      cell: (row) => (
