  ...
  useEffect(() => {
    if (isOpen && data) {
      if (
        ...
        setRequestInfoText(
          "Please provide a clearer copy of the liquidation notice."
        );
      } else {
    ...
    >
      ...
      >
        <Typography variant="body2" sx={{ color: "text.primary", py: 5 }}>
          ...
          <strong>"{data.refId} — Cancellation"</strong> request?
        </Typography>
      </Modal>
    </Drawer>
  );
