...
export function RefundsDrawer({ isOpen, onClose, data }: RefundsDrawerProps) {
  ...
  useEffect(() => {
    if (isOpen && data) {
      if (
        ...
        setRequestInfoText(
          "Please provide the full overpayment calculation schedule."
        );
      } else {
      ...
      >
        ...
        <Box>
          ...
          <Box sx={{ display: "flex", flexDirection: "column", gap: 2 }}>
            {[
              {
                name: "Overpayment_Calc.xlsx",
                meta: "2023-03-01 · XLSX",
              },
              {
                name: "Refund_Approval_Form.pdf",
                meta: "2023-03-01 · PDF",
              },
            ].map((file, index) => (
              <Paper
